    ...
    <div class="tdesign-document tdesign-source-page">
        ...
        <div class="tdesign-source-content">
            ...
            <div class="tdesign-source-content__iframe-wrap">
                <iframe class="tdesign-source-content__iframe" :src="previewUrl[tab]" width="100%" height="100%"
                    allowfullscreen></iframe>
            </div>

            <div class="tdesign-source-content-box">
                <ul class="tdesign-source-content__list">
                    <li class="tdesign-source-content__list-item" v-for="item in sourceList" :key="item.title"
                        @click="handleSourceClick(item)" :disabled="item.status === -1">
                        <div class="tdesign-source-content__list-item-inner">
                            ...
                            <div class="source-detail">
                                ...
                                <t-icon class="source-detail-action" name="download" size="16px"
                                    v-if="item.actionType === 'download'" />
                                <t-icon class="source-detail-action" name="jump" size="16px"
                                    v-else-if="item.actionType === 'jump'" />
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="tdesign-source-content-box">
                ...
                <div class="contributor-list">
                    <a class="contributor-avatar" :href="'https://github.com/' + user" target="_blank"
                        v-for="user in designContributor" :key="user">
